...
- [короткий пример example.c](example.c)
- [короткий пример ./example.c](./example.c)
- [test tests/abort_compiler/on_array.c](tests/abort_compiler/on_array.c)
- [test ./tests/abort_compiler/on_array.c](./tests/abort_compiler/on_array.c)
- xxx
...
| ID        | Version     | ZLA[0][n]                            | ZLA[0][0]                            | ZLA[n][0]                                        | other<br>sizeof(0)                   | ptr ZLA[0]                                       | VLA[0][n]                            | VLA[0][n]                            | VLA[0][n]                                | ptr VLA[0]                               |
| --------- | ----------- | ------------------------------------ | ------------------------------------ | ------------------------------------------------ | ------------------------------------ | ------------------------------------------------ | ------------------------------------ | ------------------------------------ | ---------------------------------------- | ---------------------------------------- |
| Clang     | 14 - 21     | countof_ns<br>countof_ns¹<br>countof | countof_ns<br>countof_ns¹<br>countof | **countof_ns_E**<br>**countof¹_ns_E**<br>countof | countof_ns<br>countof_ns¹<br>countof | **countof_ns_E**<br>**countof¹_ns_E**<br>countof | countof_ns<br>countof_ns¹<br>countof | countof_ns<br>countof_ns¹<br>countof | *countof_ns*_E<br>countof_ns¹<br>countof | *countof_ns*_E<br>countof_ns¹<br>countof |
| GNU       | 10 - 15     | countof_ns<br>countof_ns¹            | countof_ns<br>countof_ns¹            | **countof_ns_E**<br>**countof¹_ns_E**            | countof_ns<br>countof_ns¹            | **countof_ns_E**<br>**countof¹_ns_E**            | countof_ns<br>countof_ns¹            | countof_ns<br>countof_ns¹            | <br>countof_ns¹                          | <br>countof_ns¹                          |
| IntelLLVM | 2025.3      | countof_ns<br>countof_ns¹<br>countof | countof_ns<br>countof_ns¹<br>countof | **countof_ns_E**<br>**countof¹_ns_E**<br>countof | countof_ns<br>countof_ns¹<br>countof | **countof_ns_E**<br>**countof¹_ns_E**<br>countof | countof_ns<br>countof_ns¹<br>countof | countof_ns<br>countof_ns¹<br>countof | <br>countof_ns¹<br>countof               | <br>countof_ns¹<br>countof               |
| MSVC      | 1939 - 1944 |                                      |                                      |                                                  |                                      |                                                  |                                      |                                      |                                          |                                          |
| NVHPC     | 25.9        | countof_ns<br>~~countof_ns¹~~_W      | countof_ns<br>~~countof_ns¹~~_W      | **countof_ns_E**<br>~~countof_ns¹~~_W            | countof_ns<br>~~countof_ns¹~~_W      | **countof_ns_E**<br>~~countof_ns¹~~_W            | Broken implementation                | Broken implementation                | Broken implementation                    | Broken implementation                    |
| PGI       |             |                                      |                                      |                                                  |                                      |                                                  |                                      |                                      |                                          |                                          |
| SunPro    | 5.15        |                                      |                                      |                                                  |                                      |                                                  |                                      |                                      |                                          |                                          |

## Расширения языка C++

| ID        | Version     | ZLA[0][n]                            | ZLA[0][0]                            | ZLA[n][0]                                        | other<br>sizeof(0)                   | ptr ZLA[0]                                       |
| --------- | ----------- | ------------------------------------ | ------------------------------------ | ------------------------------------------------ | ------------------------------------ | ------------------------------------------------ |
| Clang     | 14 - 21     | countof_ns<br>countof_ns¹<br>countof | countof_ns<br>countof_ns¹<br>countof | **countof_ns_E**<br>**countof¹_ns_E**<br>countof | countof_ns<br>countof_ns¹<br>countof | **countof_ns_E**<br>**countof¹_ns_E**<br>countof |
| GNU       | 10 - 15     | countof_ns<br>countof_ns¹            | countof_ns<br>countof_ns¹            | **countof_ns_E**<br>**countof¹_ns_E**            | countof_ns<br>countof_ns¹            | **countof_ns_E**<br>**countof¹_ns_E**            |
| IntelLLVM | 2025.3      | countof_ns<br>countof_ns¹<br>countof | countof_ns<br>countof_ns¹<br>countof | **countof_ns_E**<br>**countof¹_ns_E**<br>countof | countof_ns<br>countof_ns¹<br>countof | **countof_ns_E**<br>**countof¹_ns_E**<br>countof |
| MSVC      | 1939 - 1944 |                                      |                                      |                                                  |                                      |                                                  |
| NVHPC     | 25.9        | countof_ns<br>~~countof_ns¹~~_W      | countof_ns<br>~~countof_ns¹~~_W      | **countof_ns_E**<br>~~countof_ns¹~~_W            | countof_ns<br>~~countof_ns¹~~_W      | **countof_ns_E**<br>~~countof_ns¹~~_W            |
| PGI       |             |                                      |                                      |                                                  |                                      |                                                  |
| SunPro    | 5.15        |                                      |                                      |                                                  |                                      |                                                  |
...
| countof_ns¹ | C/C++ | Макрос `countof_ns()` из "countof_ns.h" с предварительным определением `_COUNTOF_NS_WANT_С11_VLA` |
